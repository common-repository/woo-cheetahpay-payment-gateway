<?php
$shareAndSellNo = '';//'08034715310';
$denominations = [100, 200, 400, 500, 1000, 1500, 2500];
$denominationPrice = 0;
...
<?php /*    		Transfer airtime to this number <b><?= $shareAndSellNo ?></b> */?>
    		After completing this form, manually transfer the airtime to the phone number that 
    		will be displayed in the next page. You are expected to send it within 15mins
    	</div>
    	<p class="form-row form-row-wide">
	...
	<div style="margin: 15px 5px; font-weight: bold; text-align: center;">
		Powered by <a href="https://cheetahpay.com.ng">Cheetahpay</a> 
...
/*         padding: 8px 8px; */
    ...
    #airtime-pin.active, #airtime-transfer.active{
        background:-webkit-linear-gradient(0deg, rgb(117, 41, 218) 0%, rgb(153, 98, 227) 80%);
        background:-o-linear-gradient(0deg, rgb(117, 41, 218) 0%, rgb(153, 98, 227) 80%);
        background:-moz-linear-gradient(0deg, rgb(117, 41, 218) 0%, rgb(153, 98, 227) 80%);
        background:linear-gradient(0deg, rgb(117, 41, 218) 0%, rgb(153, 98, 227) 80%);
        color: #fff;
    }
